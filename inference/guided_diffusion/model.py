...
def window_partition(x, window_size):  # Partition image into windows
    """
    Args:
        x: (B, H, W, C)
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # Added time dimension does not need relative position bias
...
class SwinTransformerBlock(TimestepBlock):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, time_embed_dim=128 * 4, out_channels=128):
        super().__init__()
        self.dim = dim
